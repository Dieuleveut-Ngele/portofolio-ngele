...
export const Hero = () => {
  ...
  const imageContent = (
    ...
    >
      {/* Fix 3 — Cercles tournants : actifs sur desktop, statiques sur mobile */}
      {!isMobile ? (
        <>
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            {/* 3. Photo + salut — mobile uniquement */}
            <div className="flex justify-center mt-4 mb-20 lg:hidden">
              {imageContent}
            </div>
          ...
          {/* Colonne photo — desktop uniquement */}
          <div className="flex-1 relative hidden lg:flex justify-center mt-12 lg:mt-0">
            {imageContent}
          </div>
